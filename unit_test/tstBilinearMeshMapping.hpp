...
void mappingTest3d()
{
    ...
    UniformBilinearMeshGenerator<3> generator =
        { cell_size, global_box, periodic };

    // Create the mesh and field manager.
    auto manager =
        createBilinearMesh( TEST_MEMSPACE{}, generator,
                            halo_width,
...
void mappingTest2d()
{
    ...
    // Uniform bilinear mesh generator.
    UniformBilinearMeshGenerator<2> generator =
        { cell_size, global_box, periodic };
